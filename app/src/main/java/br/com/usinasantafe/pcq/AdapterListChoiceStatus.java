...
public class AdapterListChoiceStatus extends BaseAdapter {

    private ArrayList<ViewHolderChoice> itens;
    private StatusCriterioActivity statusCriterioActivity;

    public AdapterListChoiceStatus(StatusCriterioActivity statusCriterioActivity, ArrayList<ViewHolderChoice> itens) {
        // TODO Auto-generated constructor stub
        this.itens = itens;
        this.statusCriterioActivity = statusCriterioActivity;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            LayoutInflater inflater = (LayoutInflater) statusCriterioActivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        viewHolder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(itens.get(pos).isSelected()){
                    ...
                    statusCriterioActivity.itemSelected(pos);
                }
            }
        });
