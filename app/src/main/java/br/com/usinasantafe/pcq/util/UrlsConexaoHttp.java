...
public class UrlsConexaoHttp {
    ...
    public static String localPSTEstatica = "br.com.usinasantafe.pcq.bean.estaticas.";
    public static String localUrl = "br.com.usinasantafe.pcq.util.UrlsConexaoHttp";
